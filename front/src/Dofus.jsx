        ...
        <div style={{paddingTop: "10px"}}>
            ...
            <>
                <Callout
                    ...
                    target={"_blank"}
                    href={"https://github.com/DAKK-chaloon/dofus-multi/releases"}>https://github.com/DAKK-chaloon/dofus-multi/releases</a>
                </Callout>
                <br/>
            </>}
            <div style={{display: "flex", justifyContent: "center"}}>
                ...
                <AnchorButton
                    ...
                    text={"Bug Report"}
                    icon={"help"}
                    href={"https://github.com/DAKK-chaloon/dofus-multi/discussions"}
                    target={"_blank"}
                />
            </div>
            <br/>
